...
# bot token
BOT_TOKEN = "7549495536:AAGkuzgyW3iEnLFK3jLUYaDwZd4EGIZHYAo"
    ...
    if user_id in user_deal_data:
        ...
        if user_lang == "en":
            success_text = (
                ...
                f"🔗 Link for buyer: http://t.me/GlftElflBot?start={deal_id}"
            )
        else:
            success_text = (
                ...
                f"🔗 Ссылка для покупателя: http://t.me/GlftElflBot?start={deal_id}"
            )
...
async def buy_command(message: types.Message):
    ...
    buyer_text = (
        ...
        f"<b>Ожидайте, продавец отправит подарок менеджеру @ManagerOTC для проверки.</b>\n\n"
    ...
    seller_text = (
        ...
        f"➤ Подарок <b>необходимо передать именно менеджеру @ManagerOTC</b>, а не покупателю напрямую.\n"
...
def get_main_menu_keyboard(lang="ru"):
    if lang == "en":
        return InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="📞 Support", url="https://t.me/ManagerOTC")]
        ])
    else:
        return InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🌐 Change language", callback_data="change_language")],
            [InlineKeyboardButton(text="📞 Поддержка", url="https://t.me/ManagerOTC")]
        ])
...
def get_referral_text(user_id, lang="ru"):
    ...
    if lang == "en":
        return (
            ...
            f"http://t.me/GlftElflBot?start=ref_{user_id}\n\n"
    ...
    if callback.data == "manage_requisites":
        ...
        if deal:
            ...
            seller_confirmed_text = (
                ...
                f"1. Менеджер @ManagerOTC проверит получение подарка.\n"
            ...
            if buyer_id:
                buyer_waiting_text = (
                    ...
                    f"🔎 Менеджер @ManagerOTC проверяет наличие NFT\n\n"
...
async def show_deal_to_buyer(message, deal, lang="ru"):
    ...
    if lang == "en":
        deal_text = (
            ...
            f"If you sent a transaction without a comment, fill out the form — @ManagerOTC"
        )
    else:
        deal_text = (
            ...
            f"В случае если вы отправили транзакцию без комментария заполните форму — @ManagerOTC"
        )
